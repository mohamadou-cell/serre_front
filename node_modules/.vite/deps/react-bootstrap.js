...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp2 ? propValue : stateValue, (0, import_react19.useCallback)((value, ...args) => {
    if (handler)
      handler(value, ...args);
    setState(value);
  }, [handler])];
...
Image2.defaultProps = defaultProps13;
...
var NavLink = React44.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
  ...
  return (0, import_jsx_runtime40.jsx)(Component2, {
    ...
    ...navItemProps,
    ref,
    className: (0, import_classnames26.default)(className, bsPrefix, props.disabled && "disabled", meta.isActive && "active")
  });
});
...
var Nav2 = React45.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
  ...
  return (0, import_jsx_runtime41.jsx)(Nav_default, {
    ...
    ref,
    activeKey,
    className: (0, import_classnames27.default)(className, {
      [bsPrefix]: !isNavbar,
...
Nav2.defaultProps = defaultProps16;
...
NavbarToggle.defaultProps = defaultProps17;
...
var OffcanvasToggling = React49.forwardRef(({
  bsPrefix,
  className,
  children,
  ...props
  ...
  return (0, import_jsx_runtime45.jsx)(TransitionWrapper_default, {
    ref,
    addEndListener: transitionEndListener,
    ...props,
    childRef: children.ref,
    children: (status, innerProps) => React49.cloneElement(children, {
      ...innerProps,
...
OffcanvasToggling.defaultProps = defaultProps18;
...
var OffcanvasHeader = React50.forwardRef(({
  bsPrefix,
  className,
  ...props
}, ref) => {
...
OffcanvasHeader.defaultProps = defaultProps19;
...
var Offcanvas = React51.forwardRef(({
  ...
  const renderBackdrop = (0, import_react41.useCallback)((backdropProps) => (0, import_jsx_runtime47.jsx)("div", {
    ...backdropProps,
...
Offcanvas.defaultProps = defaultProps20;
...
var NavbarOffcanvas = React52.forwardRef((props, ref) => {
...
var NavDropdown = React54.forwardRef(({
  ...
  return (0, import_jsx_runtime53.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames34.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime52.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime52.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
Popover.defaultProps = defaultProps22;
...
Overlay2.defaultProps = defaultProps23;
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime59.jsxs)(import_jsx_runtime58.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react48.cloneElement)(children, triggerProps), (0, import_jsx_runtime57.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
OverlayTrigger.defaultProps = defaultProps24;
...
PageItem.defaultProps = defaultProps25;
...
ProgressBar.defaultProps = defaultProps26;
...
Ratio.defaultProps = defaultProps27;
...
Tabs2.defaultProps = defaultProps29;
...
ToastHeader.defaultProps = defaultProps30;
...
ToggleButtonGroup.defaultProps = defaultProps31;
...
Tooltip.defaultProps = defaultProps32;
